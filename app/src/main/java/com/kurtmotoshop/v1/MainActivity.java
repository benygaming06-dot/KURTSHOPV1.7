...
public class MainActivity extends android.app.Activity {
    ...
    private void saveSaleHistory(String receiptNo,String customer,String date,JSONArray selected,double total,String paymentMethod){
        try{JSONArray history=getArray("salesHistory");JSONObject sale=new JSONObject();sale.put("receiptNo",receiptNo);sale.put("customer",customer);sale.put("date",date);sale.put("total",total);sale.put("paymentMethod",paymentMethod);sale.put("processedBy",currentUsername);sale.put("items",new JSONArray(selected.toString()));history.put(sale);prefs.edit().putString("salesHistory",history.toString()).apply();syncCloud("sales history");}catch(Exception ignored){}
    }
